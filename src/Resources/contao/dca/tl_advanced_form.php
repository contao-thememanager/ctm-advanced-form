...
$palette = Contao\CoreBundle\DataContainer\PaletteManipulator::create()
    ...
    ->applyToPalette('default', 'tl_advanced_form');

// Extend fields
$GLOBALS['TL_DCA']['tl_advanced_form']['fields']['styleManager'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_advanced_form']['styleManager'],
    'exclude'                 => true,
...
$GLOBALS['TL_DCA']['tl_advanced_form']['fields']['attributes']['load_callback'][] = array('\\Oveleon\\ContaoComponentStyleManager\\StyleManager', 'onLoad');
$GLOBALS['TL_DCA']['tl_advanced_form']['fields']['attributes']['save_callback'][] = array('\\Oveleon\\ContaoComponentStyleManager\\StyleManager', 'onSave');
